...
@Configuration
@ComponentScan(basePackages={"com.ynyes.bbjy"})
@EnableAutoConfiguration
public class BbjyApplication extends SpringBootServletInitializer implements CommandLineRunner {
    @Autowired
    ...
    public static void main(String[] args) {
        SpringApplication.run(BbjyApplication.class, args);
    }
