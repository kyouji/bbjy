    ...
    <div class="l-list">
      ...
      <div class="menu-list">
        <div class="rule-single-select single-select">
            <select name="roleId" onchange="javascript:__doPostBack('btnSearch','')" id="roleId" style="display: none;">
                <option value=""<#if roleId??><#else>selected="selected"</#if>>所有类别</option>
                <option value="4" <#if roleId??&&roleId==4>selected="selected"</#if> >活动管理员</option>
                <option value="2" <#if roleId??&&roleId==2>selected="selected"</#if> >区县管理员</option>
                <option value="3" <#if roleId??&&roleId==3>selected="selected"</#if> >专家</option>
                <option value="5" <#if roleId??&&roleId==5>selected="selected"</#if> >合作机构</option>
            </select>
        </div>
      </div>
