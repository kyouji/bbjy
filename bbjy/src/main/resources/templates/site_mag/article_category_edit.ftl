	...
	<dd>
        <div class="rule-multi-radio multi-radio">
            <span id="rblStatus" style="display: none;">
                <input type="radio" name="infoType" value="0" <#if !cat?? || cat?? && cat.infoType?? && cat.infoType==0>checked="checked"</#if> ><label>附件</label>
                <input type="radio" name="infoType" value="1" <#if cat?? && cat.infoType?? && cat.infoType==1>checked="checked"</#if>><label>资料</label>
                <input type="radio" name="infoType" value="2" <#if cat?? && cat.infoType?? && cat.infoType==2>checked="checked"</#if>><label>日期</label>
            </span>
        </div>
    </dd>
  <dl>
