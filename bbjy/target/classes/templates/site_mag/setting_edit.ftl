...
<form method="post" action="/Verwalter/setting/save" id="form1">
    ...
    <div class="tab-content" style="display: block;">
        ...
        <dl>
            <dt>帮助资料</dt>
            <dd>
                <input id="dataUrl" name="dataUrl" type="text" datatype="*0-255" value="<#if setting??>${setting.dataUrl!""}</#if>" class="input normal upload-path">
                <div class="upload-box upload-img"></div>
                <span class="Validform_checktip"></span>
            </dd>
        </dl>        
        <dl>
            <dt>站内信息</dt>
            <dd>
                <textarea name="dataContent" rows="2" cols="20" class="input" datatype="*0-255" sucmsg=" "><#if setting??>${setting.dataContent!""}</#if></textarea>
                <span class="Validform_checktip">*提供帮助资料下载的提示信息</span>
            </dd>
        </dl>
        ...
        <dl>
            <dt>通讯地址</dt>
            <dd>
                <input name="address" type="text" value="<#if setting??>${setting.address!""}</#if>" class="input normal" datatype="*0-250" sucmsg=" ">
                <span class="Validform_checktip"></span>
            </dd>
        </dl>
        <dl>
