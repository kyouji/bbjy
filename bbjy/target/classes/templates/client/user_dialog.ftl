<div class="dialog-title">
    ...
    <a href="javascript:;" class="addrelay" title="">共享</a>
    <a href="javascript:;" class="removecollection" title="">取消关注</a>
</div>
<script>
    $(function () {
        togglenavitem('#navitem1', '#contentitem1', 'current');
     })
</script>
<div class="dialog-content">
<div class="dialog-case-nav" id="navitem1">
    <span class="current">联系记录</span>
    <span>客户信息</span>
    <span>预约签单</span>
</div>
    
    <div class="dialog-case-item" id="contentitem1">
    <!-- 联系记录 -->
    <div class="contactrecord" style="display: block;">
        <!-- 新增联系记录 -->
        <#include "/client/user_item.ftl">
    </div>
    <!-- 客户信息 -->
    <div class="customerinfo" id="wrapcustomreinfo" style="display: none;">
        <#include "/client/user_massage.ftl">
        
    </div>
    
     <!-- 预约签单 -->
                <div class="bookingcase" style="display: none;">    
